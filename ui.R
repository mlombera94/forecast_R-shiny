          ...
          fluidRow( 
            ...
            sidebarPanel(
              ...
              selectInput(inputId = "observations",
                          label = "Select the minimum of observations per SKU",
                          choice = c("8" = "8",
                                     "9" = "9",
                                     "10" = "10",
                                     "11" = "11",
              ...
              selectInput(inputId = "na_obs",
                          label = "Select the number of maximum NA observations within the previously selected recent periods",
                          choice = c("1" = "1",
                                     "2" = "2",
                                     "3" = "3",
                                     "4" = "4",
                          ...
                          width = "50%"),
              tags$hr(),
              # Outputs a checkbox that allows the user to decide whether to aggrage totals across rows and create a new column
              ...
              tabsetPanel(
                tabPanel(
                  ...
                  selectInput(inputId = "zero_obs",
                              label = "Select the number of maximum zero observations within the previously selected recent periods",
                              choice = c("12" = "12",
                                         "11" = "11",
                                         "10" = "10",
                                         "9" = "9",
